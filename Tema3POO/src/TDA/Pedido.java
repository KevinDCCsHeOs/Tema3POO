...
public class Pedido {
	public Pedido(String primPlato, String bebida) {
		CalcularPedido(primPlato, bebida);
	}
	public Pedido(String primPlato, String segPlato, String bebida) {
		CalcularPedido(primPlato, segPlato , bebida);
	}
	public Pedido(String primPlato, String segPlato, String bebida, String postre) {
		CalcularPedido(primPlato, segPlato , bebida , postre);
	}
	public void CalcularPedido(String primPlato, String bebida) {
		short total=(short)(calculaPrimPlato(primPlato)+calcularBebida(bebida));
		Tools.imprimePantalla("Total a pagar: "+total);
	}
	public void CalcularPedido(String primPlato, String segPlato,String bebida) {
		short total=(short)(calculaPrimPlato(primPlato)+calculasegPlato(segPlato)+calcularBebida(bebida));
		Tools.imprimePantalla("Total a pagar: "+total);
	}
	public void CalcularPedido(String primPlato, String segPlato,String bebida, String postre) {
		short total=(short)(calculaPrimPlato(primPlato)+calculasegPlato(segPlato)+calcularBebida(bebida)+calcularPostre(postre));
		Tools.imprimePantalla("Total a pagar: "+total);
	}
	private byte calculaPrimPlato(String primPlato) {
		byte pr1=0;
		switch (primPlato) {
	...
	private byte calculasegPlato(String segPlato) {
		byte pr2=0;
		switch (segPlato) {
	...
	private byte calcularBebida(String bebida) {
		byte prb=0;
		switch (bebida) {
	...
	private byte calcularPostre(String postre) {
		byte prp=0;
		switch (postre) {
